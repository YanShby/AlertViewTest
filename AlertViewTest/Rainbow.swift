...
class Rainbow: UIView {
    ...
    @IBInspectable var firstColor: UIColor = UIColor ( red: 0.9052, green: 1.0, blue: 0.3744, alpha: 1.0 )
    @IBInspectable var secondColor: UIColor = UIColor ( red: 0.3455, green: 0.9694, blue: 1.0, alpha: 1.0 )
    @IBInspectable var thirdColor: UIColor = UIColor ( red: 0.8661, green: 0.5821, blue: 0.9987, alpha: 1.0 )
